...
class GraphicsLine(QtWidgets.QGraphicsPathItem):
    ...
    def paint(self, painter: QtGui.QPainter, option, widget=None):
        ...
        start_point = QtCore.QPointF(self.start_point_x, self.start_point_y)
        self.line_path.moveTo(start_point)

        if self.port_one.is_input == True:
            point1 = QtCore.QPointF((self.start_point_x - 100), self.start_point_y)
        else:
            point1 = QtCore.QPointF((self.start_point_x + 100), self.start_point_y)
        
        if self.port_two.is_input == True:
            point2 = QtCore.QPointF((self.end_point_x - 100), self.end_point_y)
        else:
            point2 = QtCore.QPointF((self.end_point_x + 100), self.end_point_y)

        end_point = QtCore.QPointF(self.end_point_x, self.end_point_y)
